...
public interface SubFunctionService {
    ...
    List<SubMenuFunctionDTO.FullDTO> getAllSub(String lang);

    Optional<SubMenuFunctionDTO.FullDTO> getSub(String id, String lang);

    List<SubMenuFunctionDTO.FullDTO> getSubTrueActive(String lang);
