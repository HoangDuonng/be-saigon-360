...
public interface MenuFunctionService {
    ...
    List<MenuFunctionDTO> getAllMenu(String lang);

    Optional<MenuFunctionDTO> getMenuById(String id, String lang);

    List<MenuFunctionDTO> getMenuTrueActive(String lang);
